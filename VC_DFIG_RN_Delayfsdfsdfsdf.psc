...
"
   ...
   0.pgb([504,1044],0,123370352,770)
    {
    Name = "Erro (rad/s)"
    Group = ""
    Display = "0"
   ...
   0.pgb([630,1044],0,123365048,760)
    {
   ...
   0.pgb([630,1188],0,123360560,650)
    {
    Name = "Erro Filtro %"
    Group = ""
    Display = "0"
   ...
   0.pgb([504,1188],0,123363416,680)
    {
    Name = "Erro %"
    Group = ""
    Display = "0"
   ...
   -Plot-([1170,252],0)
    ...
    Graph([0,0],[0,0,396,135],"y")
     ...
     Options = 11
     Units = ""
     Curve(123363416,"Erro %",0,,-2,)
     Curve(123360560,"Erro Filtro %",0,,,)
     }
    }
   ...
   -Plot-([1170,450],0)
    ...
    Graph([0,0],[0,0,414,135],"y")
     ...
     Options = 129
     Units = ""
     Curve(123366680,"Vd_ref",0,,,)
     Curve(123366272,"Vq_ref",0,,,)
     }
    }
   -Plot-([792,450],0)
    {
    ...
    Graph([0,0],[0,0,378,135],"y")
     ...
     Options = 33
     Units = ""
     Curve(123347912,"Iq_ref",0,,,)
     Curve(123351992,"Id_ref",0,,,)
     }
    }
   -Plot-([1170,648],0)
    {
   ...
   0.pgb([738,1170],3,123326288,670)
    {
    Name = "Vd"
    Group = ""
    Display = "0"
   ...
   0.pgb([810,1170],3,123330776,660)
    {
    Name = "Vd1"
    Group = ""
    Display = "0"
   ...
   0.pgb([738,1044],3,123321392,740)
    {
    Name = "Iq"
    Group = ""
    Display = "0"
   ...
   0.pgb([810,1044],3,123343016,730)
    {
    Name = "Iq1"
    Group = ""
    Display = "0"
   ...
   0.pgb([882,1044],3,123344648,710)
    {
    Name = "Iq2"
    Group = ""
    Display = "0"
   ...
   0.pgb([954,1044],3,123344240,700)
    {
    Name = "Iq3"
    Group = ""
    Display = "0"
   ...
   0.pgb([882,1170],3,123340976,630)
    {
    Name = "Vd2"
    Group = ""
    Display = "0"
   ...
   0.pgb([954,1170],3,123340160,620)
    {
    Name = "Vd3"
    Group = ""
    Display = "0"
   ...
   -Plot-([792,252],0)
    ...
    Graph([0,0],[0,0,378,135],"y")
     ...
     Options = 11
     Units = ""
     Curve(123365048,"Erro Filtro (rad/s)",0,,,)
     Curve(123370352,"Erro (rad/s)",0,,-2,1)
     }
    }
   -Plot-([792,0],0)
    {
    ...
    Graph([0,0],[0,0,774,189],"Wm [RAD/S]")
     ...
     Options = 103
     Units = ""
     Curve(123381368,"Wrampa",0,,,)
     Curve(123375656,"Wm",0,,,)
     Curve(123360968,"W_est_Filtro",0,,,)
     Curve(123332000,"W_est",0,,-2,)
     }
    }
