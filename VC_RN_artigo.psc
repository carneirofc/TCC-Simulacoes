...
Definitions
 ...
 Module("Main")
  ...
  Page(A/A4,Landscape,16,[800,408],5)
   {
   .CDFIGmodel([432,144],0,0,430)
    {
    }
   0.datatap([450,234],0,0,440)
    {
    Index = "1"
    Dim = "1"
    Type = "2"
...
"
   ...
   0.pgb([540,1080],3,123350784,660)
    {
    Name = "f"
    Group = ""
    Display = "0"
   ...
   1.controlcarlos([288,468],0,0,410)
    {
    }
   ...
   0.pgb([738,1008],0,123365472,700)
    {
    Name = "Erro (rad/s)"
    Group = ""
    Display = "0"
   ...
   0.pgb([864,1008],0,123374040,690)
    {
   ...
   0.gain([864,1116],7,0,530)
    {
    G = "100"
    COM = "Gain"
    Dim = "1"
    }
   0.pgb([864,1152],0,123375264,630)
    {
    Name = "Erro Filtro %"
    Group = ""
    Display = "0"
   ...
   0.gain([738,1116],7,0,540)
    {
    G = "100"
    COM = "Gain"
    Dim = "1"
    }
   0.pgb([738,1152],0,123373224,640)
    {
    Name = "Erro %"
    Group = ""
    Display = "0"
   ...
   -Plot-([1170,252],0)
    ...
    Graph([0,0],[0,0,396,135],"y")
     ...
     Options = 11
     Units = ""
     Curve(123373224,"Erro %",0,,-2,)
     Curve(123375264,"Erro Filtro %",0,,,)
     }
    }
   0.datatap([252,342],4,0,590)
    {
    Index = "3"
    Dim = "1"
    Type = "2"
   ...
   -Plot-([1170,450],0)
    ...
    Graph([0,0],[0,0,414,135],"y")
     ...
     Options = 129
     Units = ""
     Curve(123379344,"Vd_ref",0,,,)
     Curve(123376488,"Vq_ref",0,,,)
     }
    }
   -Plot-([792,450],0)
    {
    ...
    Graph([0,0],[0,0,378,135],"y")
     ...
     Options = 1
     Units = ""
     Curve(123349968,"Iq_ref",0,,,)
     Curve(123347520,"Id_ref",0,,,)
     }
    }
   -Plot-([1170,648],0)
    {
   ...
   -Plot-([792,252],0)
    ...
    Graph([0,0],[0,0,378,135],"y")
     ...
     Options = 43
     Units = ""
     Curve(123374040,"Erro Filtro (rad/s)",0,,,)
     Curve(123365472,"Erro (rad/s)",0,,-2,1)
     }
    }
...
"
   ...
   -Plot-([792,0],0)
    ...
    Graph([0,0],[0,0,774,189],"Wm [RAD/S]")
     ...
     Options = 101
     Units = ""
     Curve(123381792,"Wrampa",0,,,)
     Curve(123385056,"Wm",0,,,)
     Curve(123369552,"W_est_Filtro",0,,,)
     Curve(123358536,"W_est",0,,-2,)
     }
    }
   0.datalabel([288,234],0,0,-1)
    {
    Name = "West_filtro"
    }
   0.realpole([324,234],0,0,400)
    {
    Limit = "0"
    COM = "Real_Pole"
    Reset = "0"
