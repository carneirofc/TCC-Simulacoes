...
"
   ...
   0.datalabel([666,126],0,0,-1)
    {
    Name = "Wref"
    }
   0.peswitch([468,360],6,0,640)
    {
    L = "1"
    Type = "3"
    SNUB = "0"
   ...
   0.polar_rec([198,1080],0,0,250)
    {
    Dir = "1"
    AngUnit = "0"
    }
   0.sumjct([306,1098],0,0,280)
    {
    DPath = "1"
    A = "0"
    B = "0"
   ...
   0.emtconst([342,1134],2,0,260)
    {
    Name = ""
    Value = "4"
    }
   0.datalabel([378,1098],0,0,-1)
    {
    Name = "Theta"
    }
   0.emtconst([522,1134],0,0,270)
    {
    Name = ""
    Value = "1"
    }
   0.div([558,1098],0,0,310)
    {
    }
   0.datalabel([612,1098],0,0,-1)
    {
    Name = "Exf"
    }
   0.ratelimit([486,1098],0,0,300)
    {
    IR = "100000 [1/s]"
    DR = "100000 [1/s]"
    COM = "Rate_Limiter"
    }
   0.derivative([414,1098],0,0,290)
    {
    T = "1 [s]"
    COM = "Derivative"
    }
   ...
   0.pgb([612,1098],3,123227992,470)
    {
    Name = "f"
    Group = ""
    Display = "0"
   ...
   1.ABCtoDQ([378,900],0,0,330)
    {
    inv = "0"
    }
   1.ABCtoDQ([630,900],0,0,340)
    {
    inv = "0"
    }
   1.ABCtoAlfBet([108,1080],0,0,240)
    {
    inv = "1"
    }
   0.datatap([540,630],0,0,60)
    {
    Index = "1"
    Dim = "1"
    Type = "2"
   ...
   1.velocidade_ref([702,72],0,0,20)
    {
    }
   0.time-sig([612,72],0,0,10)
    {
    }
   -Wire-([162,576],0,0,-1)
    {
   ...
   0.pgb([720,1098],3,123259816,460)
    {
    Name = "f_1"
    Group = ""
    Display = "0"
   ...
   -Plot-([882,558],0)
    ...
    XLabel = " "
    AutoPan = "false,75"
    Graph([0,0],[0,0,594,135],"y")
     {
     Options = 169
     Units = ""
     Curve(123251656,"Vq",0,,,)
     Curve(123241048,"Vd",0,,,)
     }
    }
   -Plot-([882,738],0)
    {
    ...
    XLabel = " "
    AutoPan = "false,75"
    Graph([0,0],[0,0,594,153],"y")
     {
     Options = 41
     Units = ""
     Curve(123250024,"Id",0,,,)
     Curve(123240232,"Iq",0,,,)
     }
    }
   0.pgb([486,108],0,123263896,680)
    {
    Name = "TL"
    Group = ""
    Display = "0"
   ...
   -Plot-([882,954],0)
    ...
    XLabel = " "
    AutoPan = "false,75"
    Graph([0,0],[0,0,576,171],"y")
     {
     Options = 161
     Units = ""
     Curve(123263896,"TL",0,,,)
     }
    }
   -Plot-([882,378],0)
    {
   ...
   1.Media_Movel([702,630],0,0,100)
    {
    }
   0.trans_filt([288,864],0,0,190)
    {
    Order = "2"
    Band = "1"
    Type = "1"
   ...
   -Plot-([882,108],0)
    ...
    Graph([0,0],[0,0,594,207],"y")
     ...
     Options = 43
     Units = ""
     Curve(123252064,"Wm_rampa",0,,,)
     Curve(123210448,"Wm",0,,,)
     Curve(123233704,"Wref",0,,-2,)
     }
    }
   }
  }
