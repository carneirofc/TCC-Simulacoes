...
"
   ...
   0.pgb([504,1044],0,122556272,770)
    {
    Name = "Erro (rad/s)"
    Group = ""
    Display = "0"
   ...
   0.pgb([630,1044],0,122505272,760)
    {
   ...
   0.pgb([630,1188],0,122512208,650)
    {
    Name = "Erro Filtro %"
    Group = ""
    Display = "0"
   ...
   0.pgb([504,1188],0,122512616,680)
    {
    Name = "Erro %"
    Group = ""
    Display = "0"
   ...
   -Plot-([1170,252],0)
    ...
    Graph([0,0],[0,0,396,135],"y")
     ...
     Options = 11
     Units = ""
     Curve(122512616,"Erro %",0,,-2,)
     Curve(122512208,"Erro Filtro %",0,,,)
     }
    }
   0.datatap([198,288],4,0,580)
    {
    Index = "3"
    Dim = "1"
    Type = "2"
   ...
   -Plot-([1170,450],0)
    ...
    Graph([0,0],[0,0,414,135],"y")
     ...
     Options = 129
     Units = ""
     Curve(122504456,"Vd_ref",0,,,)
     Curve(122513024,"Vq_ref",0,,,)
     }
    }
   -Plot-([792,450],0)
    {
    ...
    Graph([0,0],[0,0,378,135],"y")
     ...
     Options = 33
     Units = ""
     Curve(122548112,"Iq_ref",0,,,)
     Curve(122545256,"Id_ref",0,,,)
     }
    }
   -Plot-([1170,648],0)
    {
   ...
   0.pgb([738,1170],3,122824584,670)
    {
    Name = "Vd"
    Group = ""
    Display = "0"
   ...
   0.pgb([810,1170],3,122822544,660)
    {
    Name = "Vd1"
    Group = ""
    Display = "0"
   ...
   0.pgb([738,1044],3,122826624,740)
    {
    Name = "Iq"
    Group = ""
    Display = "0"
   ...
   0.pgb([810,1044],3,122831520,730)
    {
    Name = "Iq1"
    Group = ""
    Display = "0"
   ...
   0.pgb([882,1044],3,122824176,710)
    {
    Name = "Iq2"
    Group = ""
    Display = "0"
   ...
   0.pgb([954,1044],3,122828256,700)
    {
    Name = "Iq3"
    Group = ""
    Display = "0"
   ...
   0.pgb([882,1170],3,122832336,630)
    {
    Name = "Vd2"
    Group = ""
    Display = "0"
   ...
   0.pgb([954,1170],3,122832744,620)
    {
    Name = "Vd3"
    Group = ""
    Display = "0"
   ...
   -Plot-([792,252],0)
    ...
    Graph([0,0],[0,0,378,135],"y")
     ...
     Options = 11
     Units = ""
     Curve(122505272,"Erro Filtro (rad/s)",0,,,)
     Curve(122556272,"Erro (rad/s)",0,,-2,1)
     }
    }
   ...
   -Plot-([792,0],0)
    ...
    Graph([0,0],[0,0,774,189],"Wm [RAD/S]")
     ...
     Options = 103
     Units = ""
     Curve(122506088,"Wrampa",0,,,)
     Curve(122506496,"Wm",0,,,)
     Curve(122564840,"W_est_Filtro",0,,-2,)
     Curve(122829480,"W_est",0,,-2,)
     }
    }
   }
  }
